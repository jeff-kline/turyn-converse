...
\texttt{condition\_c\_absorption.py} (a diagnostic-table generator
retained in the companion source repository, not among the shipped
\texttt{code/} scripts) and are provided as the machine-readable cache
\texttt{code/data/condition\_c\_absorption\_qmax2000\_degree40.jsonl}.
...
(Claude) under human direction, with machine-verified audits for the
